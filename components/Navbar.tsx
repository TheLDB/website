        ...
        <div className="w-full h-28 flex justify-center items-center">
            <div className="w-full h-full flex">
                <div className="w-full h-full p-4 flex items-center justify-center space-x-2">
                    ...
                    <h1 className="font-mono text-white font-semibold text-2xl">|</h1>
                    <Link href="/">
                        <h1 className="font-mono text-site-white font-light text-2xl link-underline link-underline-black hover:cursor-pointer">₿ ${cryptoPrices?.btcPrice.toLocaleString()}</h1>
                    </Link>
                    <h1 className="font-mono text-white font-semibold text-2xl">|</h1>
                    <Link href="/">
                        <h1 className="font-mono text-site-white font-light text-2xl link-underline link-underline-black hover:cursor-pointer">Ξ ${cryptoPrices?.ethPrice.toLocaleString()}</h1>
                    </Link>
                </div>
            </div>
        </div>
