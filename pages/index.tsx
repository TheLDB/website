        ...
        <>
            ...
            <div className="flex min-h-screen flex-col space-y-8 items-center justify-center py-12 px-24 bg-site-black">
                ...
                <div className="w-full flex flex-col space-y-4">
                    ...
                    <ExpCard company="Classmates Delivery" title="Co-Founder" href="/" color="text-orange-400" border="border-orange-400" desc="Built a school focused food delivery startup with a classmate. Launched in 1 school and talked to several others before COVID-19." img="/SpringsIT.png" />
                </div>
                <div className="w-full flex flex-col space-y-4">
